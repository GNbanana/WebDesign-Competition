...
this.aLi=this.wrap.getElementsByTagName("li");this.prev=this.wrap.getElementsByTagName("pre")[0];this.next=this.wrap.getElementsByTagName("pre")[1];
this.timer=null;this.aSort=[];this.iCenter=3;this._doPrev=function(){return _this.doPrev.apply(_this)};
this._doNext=function(){return _this.doNext.apply(_this)};
/*图片大小*/
this.options=[
    {width:262,height:170,top:92,left:20,zIndex:1},
    {width:262,height:170,top:92,left:20,zIndex:2},
    {width:262,height:190,top:80,left:200,zIndex:3},
    {width:270,height:300,top:30,left:420,zIndex:4},
    {width:262,height:190,top:80,left:668,zIndex:3},
    {width:262,height:170,top:92,left:834,zIndex:2},
    {width:262,height:170,top:92,left:450,zIndex:1}];

for(var i=0;i<this.aLi.length;i++)this.aSort[i]=this.aLi[i];
this.aSort.unshift(this.aSort.pop());
    this.setUp();this.addEvent(this.prev,"click",this._doPrev);
    this.addEvent(this.next,"click",this._doNext);this.doImgClick();
